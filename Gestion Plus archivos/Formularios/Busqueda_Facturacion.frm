VERSION 5.00
Begin {C62A69F0-16DC-11CE-9E98-00AA00574A4F} Busqueda_Facturacion 
   Caption         =   "Buscar"
   ClientHeight    =   5520
   ClientLeft      =   110
   ClientTop       =   450
   ClientWidth     =   14880
   OleObjectBlob   =   "Busqueda_Facturacion.frx":0000
   StartUpPosition =   1  'Centrar en propietario
End
Attribute VB_Name = "Busqueda_Facturacion"
...
' ============================================================================
' FORMULARIO: Busqueda_Facturacion
' PROPÓSITO:  Búsqueda de facturas por rango de fechas y descripción.
...
Private Sub Btn_Active_Click()
    ...
    resultados = modBusquedas.BuscarFacturas(fechaInicio, fechaFin, descripcion, filasOriginales)
    ...
    MsgBox "No se encontraron facturas para el período seleccionado.", vbInformation, "Sin resultados"
End Sub
...
Private Sub lstResultados_DblClick(ByVal Cancel As MSForms.ReturnBoolean)
    ...
    Call modBusquedas.NavegarAFilaOriginal(numFilaOriginal, HOJA_FACTURAS)
    Unload Me
End Sub
...
Private Sub UserForm_Initialize()
    ...
    With Me.lstResultados
        .ColumnCount = 5
        .ColumnWidths = "95;90;110;110;110"
    End With
    ...
    Call modBusquedas.CargarDescripcionesUnicas(tbl, 1, Me.Txt_Descripcion)
End Sub

' --- CALENDARIO ---------------------------------------------------------------
Private Sub boton_calendario_covered_Click()
    seleccion_destino_calendario = 7
    frmCalendario.Show
End Sub

Private Sub boton_calendario_covered2_Click()
    seleccion_destino_calendario = 8
    frmCalendario.Show
End Sub
